...
/**
 * Правила гексагональной архитектуры telematics, проверяемые на каждом {@code ./gradlew test}.
 ...
 */
@AnalyzeClasses(packages = "dev.ubi.telematics", importOptions = ImportOption.DoNotIncludeTests.class)
