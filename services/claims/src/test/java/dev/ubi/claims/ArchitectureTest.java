...
/**
 * Правила гексагональной архитектуры claims, проверяемые на каждом {@code ./gradlew test}.
 ...
 */
@AnalyzeClasses(packages = "dev.ubi.claims", importOptions = ImportOption.DoNotIncludeTests.class)
